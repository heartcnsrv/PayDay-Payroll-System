...
/* Default deduction/business rules used by payroll_calculate(). */
...
/*
 * Business-logic layer. It receives struct data already loaded from CSV,
 * computes a payroll record, and returns it to the caller for saving.
 */
